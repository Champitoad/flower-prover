...
var $author$project$Main$fgColor = function (polarity) {
	if (polarity.$ === 'Pos') {
		return A3($mdgriffith$elm_ui$Element$rgb, 0, 0, 0);
	} else {
		return A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								$author$project$Main$fgColor(context.polarity)),
				...
				var petalsEl = A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$spacing($author$project$Main$borderWidth)
						]),
					A2(
					...
					_Utils_ap(
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$padding($author$project$Main$borderWidth),
								$mdgriffith$elm_ui$Element$Background$color(
								$author$project$Main$fgColor(context.polarity)),
								$mdgriffith$elm_ui$Element$Border$color(
								$author$project$Main$fgColor(context.polarity)),
								...
								{
									blur: 15,
									color: $author$project$Main$fgColor(context.polarity),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$Main$viewGoal(model));
};
