...
var $author$project$Main$Flower = F2(
	function (a, b) {
		return {$: 'Flower', a: a, b: b};
	});
var $author$project$Main$Garden = function (a) {
	return {$: 'Garden', a: a};
};
var $author$project$Main$implies = F2(
	function (a, b) {
		return A2(
			$author$project$Main$Flower,
			$author$project$Main$Garden(
				_List_fromArray(
					[
						$author$project$Main$Atom(a)
					])),
			_List_fromArray(
				[
					$author$project$Main$Garden(
					_List_fromArray(
						[
							$author$project$Main$Atom(b)
						]))
				]));
	});
var $author$project$Main$criticalPair = A2(
	$author$project$Main$Flower,
	$author$project$Main$Garden(
		_List_fromArray(
			[
				A2(
				$author$project$Main$Flower,
				$author$project$Main$Garden(_List_Nil),
				_List_fromArray(
					[
						$author$project$Main$Garden(
						_List_fromArray(
				...
				A2($author$project$Main$implies, 'a', 'c'),
				A2($author$project$Main$implies, 'b', 'c')
			])),
	_List_fromArray(
		[
			$author$project$Main$Garden(
...
var $author$project$Main$fillZip = F2(
	function (zip, bouquet) {
		switch (zip.$) {
			case 'Bouquet':
				var left = zip.a;
				var right = zip.b;
			...
			case 'Pistil':
				...
				return _List_fromArray(
					[
						A2(
						$author$project$Main$Flower,
						$author$project$Main$Garden(bouquet),
						petals)
					]);
			default:
				var pistil = zip.a;
				var leftPetals = zip.b;
				var rightPetals = zip.c;
				return _List_fromArray(
					[
						A2(
						$author$project$Main$Flower,
...
var $author$project$Main$fillZipper = $elm$core$List$foldl($author$project$Main$fillZip);
								...
								if (((!_v1.b.b) && _v1.c.b) && (_v1.c.a.$ === 'Pistil')) {
									if (_v1.c.a.a.b && (!_v1.c.a.a.b.b)) {
										...
										if (((_v1.c.b.b && (_v1.c.b.a.$ === 'Bouquet')) && _v1.c.b.b.b) && (_v1.c.b.b.a.$ === 'Pistil')) {
											...
											var petals = _v11.a.a;
											var parent = _v11.b;
											var pistil = $author$project$Main$Garden(
												_Utils_ap(left, right));
											var case_ = function (branch) {
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Main$Bouquet = F2(
	function (a, b) {
		return {$: 'Bouquet', a: a, b: b};
	});
var $author$project$Main$Context = F2(
	function (zipper, polarity) {
		return {polarity: polarity, zipper: zipper};
	});
var $author$project$Main$Pos = {$: 'Pos'};
...
var $author$project$Main$Petal = F3(
	function (a, b, c) {
		return {$: 'Petal', a: a, b: b, c: c};
	});
var $author$project$Main$Pistil = function (a) {
	return {$: 'Pistil', a: a};
};
...
var $author$project$Main$flowerBorderRound = 10;
...
var $author$project$Main$dropTarget = function () {
	...
	return {
		active: A2(
			$elm$core$List$cons,
			$mdgriffith$elm_ui$Element$Background$color(
				A4($mdgriffith$elm_ui$Element$rgba, 1, 0.8, 0, 0.5)),
			border),
		borderWidth: width,
		inactive: border
	};
...
var $author$project$Main$flowerBackgroundColor = function (polarity) {
	if (polarity.$ === 'Pos') {
...
var $author$project$Main$flowerBorderWidth = 3;
var $author$project$Main$flowerForegroundColor = function (polarity) {
	if (polarity.$ === 'Pos') {
		return A3($mdgriffith$elm_ui$Element$rgb, 0, 0, 0);
	} else {
		return A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
...
var $author$project$Main$Neg = {$: 'Neg'};
var $author$project$Main$invert = function (polarity) {
	if (polarity.$ === 'Pos') {
		return $author$project$Main$Neg;
	} else {
		return $author$project$Main$Pos;
	}
};
var $author$project$Utils$List$forkPrefix = F2(
	function (list1, list2) {
			...
			function (acc, l1, l2) {
				...
				while (true) {
					...
					if (_v0.a.b && _v0.b.b) {
						...
						var t2 = _v2.b;
						if (_Utils_eq(h1, h2)) {
							var $temp$acc = A2($elm$core$List$cons, h1, acc),
								$temp$l1 = t1,
								$temp$l2 = t2;
							acc = $temp$acc;
							l1 = $temp$l1;
		...
		return A3(aux, _List_Nil, list1, list2);
	});
var $author$project$Utils$List$forkSuffix = F2(
	function (list1, list2) {
		var _v0 = A2(
			$author$project$Utils$List$forkPrefix,
			$elm$core$List$reverse(list1),
			$elm$core$List$reverse(list2));
		var l = _v0.a;
		var l1 = _v0.b;
		var l2 = _v0.c;
		return _Utils_Tuple3(
			$elm$core$List$reverse(l),
			$elm$core$List$reverse(l1),
			$elm$core$List$reverse(l2));
	});
var $author$project$Utils$List$longestCommonSuffix = F2(
	function (l1, l2) {
		var _v0 = A2($author$project$Utils$List$forkSuffix, l1, l2);
		var suffix = _v0.a;
		return suffix;
	});
var $author$project$Main$justifies = F2(
	function (source, destination) {
		var lca = A2($author$project$Utils$List$longestCommonSuffix, source, destination);
		if (source.b && (source.a.$ === 'Bouquet')) {
			if (source.b.b && (source.b.a.$ === 'Pistil')) {
				var _v1 = source.a;
				var parent = source.b;
				var grandParent = parent.b;
				return _Utils_eq(lca, grandParent) || _Utils_eq(lca, parent);
			} else {
				var _v2 = source.a;
				var parent = source.b;
				return _Utils_eq(lca, parent);
			}
		} else {
			return false;
		}
...
var $author$project$Main$Justify = {$: 'Justify'};
...
var $author$project$Main$hypsZip = function (zip) {
	switch (zip.$) {
		case 'Bouquet':
			var left = zip.a;
			var right = zip.b;
			return _Utils_ap(left, right);
		case 'Pistil':
			return _List_Nil;
		default:
			var bouquet = zip.a.a;
...
var $author$project$Main$hypsZipper = function (zipper) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (zip, acc) {
				return _Utils_ap(
					$author$project$Main$hypsZip(zip),
					acc);
			}),
		_List_Nil,
		zipper);
...
var $author$project$Main$isHypothesis = F2(
	function (flower, zipper) {
		return A2(
			$elm$core$List$member,
			flower,
			$author$project$Main$hypsZipper(zipper));
	});
...
var $author$project$Utils$List$zipperMap = F2(
	function (f, list) {
		var aux = F2(
			function (left, l) {
				if (!l.b) {
					...
					function (lr, flower) {
						...
						return _List_fromArray(
							[
								...
								_Utils_Tuple2(
									left,
									A2($elm$core$List$cons, flower, right))),
								A2(flowerEl, lr, flower)
							]);
					});
				return _Utils_ap(
					$elm$core$List$concat(
						A2($author$project$Utils$List$zipperMap, sperse, bouquet)),
					_List_fromArray(
						[
							dropZone(
	...
	var item = F2(
		function (mode, position) {
			...
			var changeAction = _List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Main$ChangeUIMode(mode)),
					$mdgriffith$elm_ui$Element$pointer
				]);
			var borderRound = function () {
				switch (position.$) {
					case 'Start':
						return {bottomLeft: borderRoundSize, bottomRight: 0, topLeft: borderRoundSize, topRight: 0};
					case 'Middle':
						return {bottomLeft: 0, bottomRight: 0, topLeft: 0, topRight: 0};
					default:
						return {bottomLeft: 0, bottomRight: borderRoundSize, topLeft: 0, topRight: borderRoundSize};
				}
			}();
			var _v0 = isSelected ? _Utils_Tuple2(
				A3($mdgriffith$elm_ui$Element$rgb255, 58, 134, 255),
				A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1)) : _Utils_Tuple2(
				A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$rounded(borderRoundSize),
				$mdgriffith$elm_ui$Element$Border$color(borderColor),
				$mdgriffith$elm_ui$Element$Background$color(borderColor)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$viewToolbar = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewModeSelector(model.mode)
			]));
};
var $author$project$Main$view = function (model) {
	var toolbar = $author$project$Main$viewToolbar(model);
	var goal = $author$project$Main$viewGoal(model);
	var app = A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[goal, toolbar]));
	return A2($mdgriffith$elm_ui$Element$layout, _List_Nil, app);
};
